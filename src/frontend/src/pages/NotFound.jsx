...
export default function NotFound() {
  return (
    <>
      ...
      />
      <div className="relative flex flex-col items-center justify-center min-h-screen p-6 overflow-hidden z-1 bg-white z-1 dark:bg-gray-900">
        <div className="mx-auto w-full max-w-[242px] text-center sm:max-w-[472px]">
          ...
          <img src={ErrorImg} alt="404" className="hidden dark:block" />
